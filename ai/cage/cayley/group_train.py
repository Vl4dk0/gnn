...
Usage:
    uv run python -m ai.cage.cayley.group_train \\
...
from ai.cage.cayley.group_data_gen import generate_group_dataset
from ai.cage.cayley.group_model import GroupPromisePredictor
