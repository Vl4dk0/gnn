...
export const StoryCard = ({ href, title, description, number }: StoryCardProps) => {
  return (
    <Link to={href} className="block text-inherit no-underline">
      <article className="relative h-full rounded-[10px] border-2 border-line2 bg-bg2 p-5 transition-all duration-200 hover:border-textDim hover:shadow-[0_8px_24px_rgba(0,0,0,0.35)]">
        {number && (
